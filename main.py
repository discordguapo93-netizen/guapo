...
async def main():
    await client.start()
    client.loop.create_task(monitor_users())  # tâche de suivi en arrière-plan
    await client.run_until_disconnected()     # garde le bot actif
